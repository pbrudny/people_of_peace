...
class CoordinatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coordinator" do
    assert_difference('Coordinator.count') do
      post coordinators_url, params: { coordinator: { address: @coordinator.address, email: @coordinator.email, fb: @coordinator.fb, first_name: @coordinator.first_name, last_name: @coordinator.last_name, note: @coordinator.note, phone: @coordinator.phone, skype: @coordinator.skype } }
    end
  ...
  test "should update coordinator" do
    patch coordinator_url(@coordinator), params: { coordinator: { address: @coordinator.address, email: @coordinator.email, fb: @coordinator.fb, first_name: @coordinator.first_name, last_name: @coordinator.last_name, note: @coordinator.note, phone: @coordinator.phone, skype: @coordinator.skype } }
